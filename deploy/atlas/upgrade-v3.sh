...
trap - ERR
echo 'ATLAS_V3_8_UPGRADED: release-candidate responsive bilingual relay dashboard=127.0.0.1:8787; A2A-v5.4; live polling=10s; collection=30s'
